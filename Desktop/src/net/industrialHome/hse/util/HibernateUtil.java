 ...
 * into Hibernate objects. It is a generic class. You can use it on you app if
 * you use ExtJS Filters.
 * 
...
public class HibernateUtil<E> {
	...
	public List<Criterion> getRestrictions(List<ExtJSFilter> filters)
		...
		for (ExtJSFilter filter : filters) {
			...
			if (filter.getType().equals("string")) {
				...
				restrictions.add(getComparison(filter.getComparison(),
						filter.getField(),
						getNumericValue(filter.getValue(), filter.getField())));
	 ...
	 * @throws NoSuchFieldException
	 */
	private Object getNumericValue(String value, String field)
