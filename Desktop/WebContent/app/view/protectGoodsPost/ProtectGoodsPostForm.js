Ext.define('MyDesktop.app.view.protectGoodsPerson.ProtectGoodsPostForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.protectGoodsPersonForm',
    requires:['MyDesktop.app.store.ConsumingGoodStore','MyDesktop.app.store.ConsumingGoodsGroupStore','MyDesktop.app.store.Posts'],
    autoScroll: true,
    rtl: true,
    closable:true,
    bodyPadding: 10,
